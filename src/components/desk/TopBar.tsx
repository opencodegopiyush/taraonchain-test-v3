...
/* ── top bar — v16: wordmark · file id · review % · FILE.
   sticky to the window (the whole document scrolls now).
   no pause button — v16 has no idle motion to pause; no
   chapter stepper — the ruler on the plate and the reader's
   own scroll ARE the navigation. */
...
export default function TopBar() {
  ...
  return (
    <header className="hairline-b sticky top-0 z-30 flex h-12 items-center gap-3 bg-[var(--paper)] px-3 sm:px-5">
      <button
        onClick={home}
