          ...
          <div className="mt-10 flex flex-col gap-10">
            ...
            <section>
              ...
              <div className="mt-4 flex flex-col gap-4">
                {CASE.findings.map((f) => (
                  <article key={f.id} className="border p-4" style={{ borderColor: "var(--line)", background: "rgba(242,234,216,0.015)" }}>
                ...
                <table className="w-full min-w-[640px] border-collapse">
                  ...
                  <tbody>
                    {CASE.evidence.map((r, i) => (
                      <tr key={i} className="transition-colors hover:bg-[rgba(242,234,216,0.025)]">
