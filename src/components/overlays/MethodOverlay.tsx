            ...
            <section>
              ...
              <div className="mt-4 grid gap-2.5 sm:grid-cols-3">
                {[
                  ...
                  <div key={k} className="border p-3.5" style={{ borderColor: "var(--line)", background: "rgba(236,238,242,0.015)" }}>
...
function Register({ color, title, body, example }: { color: string; title: string; body: string; example: string }) {
  return (
    <div className="border p-4" style={{ borderColor: "var(--line)", background: "rgba(236,238,242,0.015)" }}>
