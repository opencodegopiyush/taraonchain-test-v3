      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-3.5 lg:px-10" style={{ borderBottom: "1px solid var(--line)" }}>
          <div className="flex items-center gap-3 min-w-0">
            <button
              onClick={goHome}
              className="group inline-flex items-center gap-2 rounded-sm px-1 py-1 transition-colors hover:bg-[rgba(230,234,244,0.05)]"
              ...
              <section>
                ...
                <div className="mt-4 flex flex-col gap-4">
                  {dossier.findings.map((f) => (
                    <article key={f.id} className="border p-4" style={{ borderColor: "var(--line)", background: "rgba(230,234,244,0.015)" }}>
                ...
                <table className="w-full min-w-[600px] border-collapse">
                  ...
                  <tbody>
                    {dossier.evidence.map((r, i) => (
                      <tr key={i} className="transition-colors hover:bg-[rgba(230,234,244,0.025)]">
