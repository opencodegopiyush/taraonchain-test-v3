              ...
              <div className="mt-4 flex flex-col gap-2.5">
                {saved.map((s, i) => (
                  <button
                    key={s.dbId}
                    onClick={() => openCase(s)}
                    className="rise group pointer-events-auto w-full border px-4 py-4 text-left backdrop-blur-[2px] transition-colors hover:bg-[rgba(230,234,244,0.04)] sm:px-5 sm:py-5"
