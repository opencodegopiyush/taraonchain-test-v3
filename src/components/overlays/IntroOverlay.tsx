        ...
        <div className="flex min-h-full select-none flex-col px-5 pb-[max(30px,env(safe-area-inset-bottom))] pt-[max(44px,calc(env(safe-area-inset-top)+28px))] sm:px-12 lg:px-20">
          <div className="mx-auto w-full max-w-[680px] lg:mx-0">
              ...
              <div className="mt-4 flex flex-col gap-2.5">
                {saved.map((s, i) => (
                  <button
                    key={s.dbId}
                    onClick={() => openCase(s)}
                    className="rise group pointer-events-auto w-full border px-4 py-4 text-left backdrop-blur-[2px] transition-colors hover:bg-[rgba(242,234,216,0.04)] sm:px-5 sm:py-5"
                    style={{ borderColor: "var(--line-strong)", background: "rgba(19,15,10,0.55)", animationDelay: `${680 + i * 110}ms` }}
                ...
                {saved.length === 0 && !failed && (
                  <div
                    ...
                    style={{ borderColor: "var(--line)", background: "rgba(19,15,10,0.45)" }}
                  >
                ...
                {failed && (
                  <p className="doc border px-4 py-3.5 text-[12.5px] italic leading-relaxed sm:px-5" style={{ borderColor: "var(--line)", color: "var(--ink-faint)", background: "rgba(19,15,10,0.4)" }}>
            ...
            <div
              ...
              style={{ animationDelay: "700ms", borderColor: "var(--line)", background: "rgba(19,15,10,0.4)" }}
            >
