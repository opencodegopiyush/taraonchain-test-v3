...
const TEAL = new THREE.Color("#3fcfa4");
  ...
  return (
    <div className="fixed inset-0 z-0" style={{ touchAction: "pan-y" }} aria-hidden>
      ...
      >
        ...
        <fogExp2 attach="fog" args={["#050606", 0.0125]} />
        <ambientLight intensity={0.5} />
        <directionalLight position={[18, 26, 12]} intensity={1.15} color="#f2ede2" />
        <directionalLight position={[-16, -8, -14]} intensity={0.35} color="#3fcfa4" />
