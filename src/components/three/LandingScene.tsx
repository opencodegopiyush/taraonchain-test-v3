...
const AMBER = new THREE.Color("#4d8dff");
const TEAL = new THREE.Color("#3ecf9a");
const BONE = new THREE.Color("#eceef2");
  ...
  return (
    <div className="fixed inset-0 z-0" style={{ touchAction: "pan-y" }} aria-hidden>
      ...
      >
        ...
        <fogExp2 attach="fog" args={["#070809", 0.0125]} />
        <ambientLight intensity={0.5} />
        <directionalLight position={[18, 26, 12]} intensity={1.15} color="#e8f0ff" />
        <directionalLight position={[-16, -8, -14]} intensity={0.35} color="#3ecf9a" />
