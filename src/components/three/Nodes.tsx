  ...
  return (
    <group ref={group}>
      ...
      <mesh ref={ringSel} visible={false}>
        ...
        <meshBasicMaterial color="#e8a33d" transparent opacity={0.85} side={THREE.DoubleSide} blending={THREE.AdditiveBlending} depthWrite={false} />
      </mesh>
      {/* hover ring */}
      <mesh ref={ringHover} visible={false}>
        <ringGeometry args={[0.965, 1.0, 48]} />
        <meshBasicMaterial color="#e8e4da" transparent opacity={0.4} side={THREE.DoubleSide} blending={THREE.AdditiveBlending} depthWrite={false} />
      </mesh>
    </group>
  );
}
