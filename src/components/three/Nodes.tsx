  ...
  return (
    <group ref={group}>
      ...
      <mesh ref={ringSel} visible={false}>
        ...
        <meshBasicMaterial color="#a78bfa" transparent opacity={0.85} side={THREE.DoubleSide} blending={THREE.AdditiveBlending} depthWrite={false} />
      </mesh>
      {/* hover ring */}
      <mesh ref={ringHover} visible={false}>
        <ringGeometry args={[0.965, 1.0, 48]} />
        <meshBasicMaterial color="#e6eaf4" transparent opacity={0.4} side={THREE.DoubleSide} blending={THREE.AdditiveBlending} depthWrite={false} />
      </mesh>
    </group>
  );
}
