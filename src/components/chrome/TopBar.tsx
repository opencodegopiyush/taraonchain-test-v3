...
export function TopBar() {
  ...
  return (
    <header
      ...
      style={{
        background: "linear-gradient(to bottom, rgba(12,9,6,0.92) 55%, rgba(12,9,6,0.75))",
    ...
    >
      <div className="flex items-center gap-3 min-w-0 lg:gap-5">
        ...
        <button
          onClick={home}
          className="group flex items-center gap-2.5 rounded-sm px-1 py-1 -ml-1 transition-colors hover:bg-[rgba(242,234,216,0.05)]"
