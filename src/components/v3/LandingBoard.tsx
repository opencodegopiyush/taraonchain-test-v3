            ...
            <section className="rise mt-8" style={{ animationDelay: "580ms" }} aria-label="investigations">
              ...
              <div className="flex flex-col gap-2.5">
                ...
                {saved.length === 0 && !failed && (
                  <div className="border px-4 py-4" style={{ borderColor: "var(--line)", background: "rgba(8,9,9,0.45)" }}>
                ...
                {failed && (
                  <p
                    ...
                    style={{ borderColor: "var(--line)", color: "var(--ink-faint)", background: "rgba(8,9,9,0.4)" }}
                  >
...
function Ticker({ saved }: { saved: SavedInvestigation[] }) {
  const line = useMemo(() => {
    ...
    bits.push("EVERY ADDRESS VERIFIABLE ON-CHAIN", "TARAONCHAIN · TEST BUILD V3");
  ...
  return (
    <div
      ...
      style={{ borderColor: "var(--line)", background: "rgba(9, 11, 10, 0.94)" }}
      aria-hidden
    >
