...
import { CaseStatus, spawnRipple } from "@/components/ui/bits";
              ...
              <div className="flex flex-col gap-2.5">
                {saved.map((s, i) => (
                  <button
                    ...
                    className={`t3-openbtn t4-ripple-host rise group pointer-events-auto w-full border px-4 py-4 text-left sm:px-5 ${i === 0 ? "gold-glow" : ""}`}
                    style={{
                ...
                {saved.length === 0 && !failed && (
                  <div className="border px-4 py-4" style={{ borderColor: "var(--line)", background: "rgba(19,15,10,0.45)" }}>
                ...
                {failed && (
                  <p
                    ...
                    style={{ borderColor: "var(--line)", color: "var(--ink-faint)", background: "rgba(19,15,10,0.4)" }}
                  >
...
/* drifting gold dust behind the landing content — pure css */
const DUST = [
  { left: "6%",  s: 5, t: "12s", d: "0s",    x: "26px",  o: 0.5 },
  { left: "14%", s: 3, t: "9s",  d: "2.4s",  x: "-18px", o: 0.42 },
  { left: "22%", s: 6, t: "14s", d: "1.1s",  x: "34px",  o: 0.34 },
  { left: "31%", s: 4, t: "10s", d: "3.8s",  x: "-24px", o: 0.5 },
  { left: "44%", s: 3, t: "8s",  d: "0.7s",  x: "20px",  o: 0.4 },
  { left: "57%", s: 5, t: "13s", d: "2s",    x: "-30px", o: 0.46 },
  { left: "66%", s: 4, t: "9.5s",d: "4.4s",  x: "24px",  o: 0.38 },
  { left: "74%", s: 6, t: "15s", d: "1.7s",  x: "-20px", o: 0.3 },
  { left: "83%", s: 3, t: "10.5s", d: "3.1s", x: "28px", o: 0.44 },
  { left: "91%", s: 5, t: "12.5s", d: "0.3s", x: "-26px", o: 0.5 },
  { left: "50%", s: 3, t: "11s",  d: "5.2s", x: "18px",  o: 0.36 },
  { left: "37%", s: 4, t: "9s",   d: "6s",   x: "-16px", o: 0.42 },
];

function GoldDust() {
  return (
    <div className="gold-dust-field" aria-hidden style={{ position: "fixed", inset: 0, zIndex: 0 }}>
      {DUST.map((p, i) => (
        <span
          key={i}
          style={{
...
function ChainWindow() {
  ...
  return (
    <Frame
      className="gold-glow h-[300px] w-full sm:h-[360px] lg:h-[440px]"
      scan
      label={
...
function Ticker({ saved }: { saved: SavedInvestigation[] }) {
  const line = useMemo(() => {
    ...
    bits.push("EVERY ADDRESS VERIFIABLE ON-CHAIN", "TARAONCHAIN · TEST BUILD V5");
  ...
  return (
    <div
      ...
      style={{ borderColor: "var(--line)", background: "rgba(17, 13, 8, 0.94)" }}
      aria-hidden
    >
